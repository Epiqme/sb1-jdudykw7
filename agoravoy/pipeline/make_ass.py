...
optionally a no-box title slam (e.g. "DEAL SCAN #1", same outline style) at the
top of the frame during the opening B-roll.
...
Style: Title,Bebas Neue,110,&H00FFFFFF,&H00FFFFFF,&H00000000,&H00000000,0,0,0,0,100,100,2,0,1,10,0,8,60,120,500,1
